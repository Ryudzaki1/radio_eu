...
1. Создать публичный канал, например `BAA Vipe`.
2. Зарезервировать короткий username канала, сейчас используется `@baa_vipe`.
3. Добавить `baa_vipe_bot` администратором канала.
